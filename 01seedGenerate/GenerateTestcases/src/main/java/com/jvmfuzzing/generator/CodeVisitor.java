...
public class CodeVisitor{
    ...
    // class CountOfVarUsage{
    //     private int count;
    //     private String varName;
    //     private String varType;

    //     public CountOfVarUsage(String varName, String varType){
    //         this.count = 0;
...
//            System.out.println("argument:"+paraList);
    ...
    // class WrongWhenVisitClass extends Exception{
    //     WrongWhenVisitClass(String s){
    //         super(s);
    //     }
    // }
    ...
    // public String createTestcase(ClassOrInterfaceDeclaration oldClass, int id, List<String> needfulArgList, List<ImportDeclaration){
...
//        globalVarList.forEach(System.out::println);
        ...
        importList.forEach(newCUnit::addImport);
...
//                System.out.println("oneComponent: "+oneComponent.toString());
                ...
                if(!oneComponent.getImportStmt().isEmpty()){
    ...
    // public String visitClass(ClassOrInterfaceDeclaration classNode, List<String> needfulArgList){        
        // Create the main method,add content in it.
        // String code = "";
        // MethodDeclaration addMethod = classNode.addMethod("main",PUBLIC,STATIC);
        // BlockStmt methodBody = addMethod.createBody();
        // try{
            // for(int i=0;i<needfulArgList.size();i++){
                // System.out.println("will insert:"+needfulArgList.get(i));
                // methodBody.addStatement(needfulArgList.get(i));
                // System.out.println("already insert:"+methodBody.getStatement(i));
            // }
            // addMethod.addParameter(String[].class,"args");
            // classNode = addThrowExceptionToMain(classNode,addMethod);
            // code = classNode.toString();
        // } catch (Exception e){
            // e.printStackTrace();
            // throw new WrongWhenVisitClass(e.getMessage());
        // }
        // String code = createTestcase(classNode,1,needfulArgList);
        // return code;
    // }

...
public class VariableGenerater 
{
    ...
    // static TestcaseGenerater t = new TestcaseGenerater();
    ...
    // public String getImportStr(CompilationUnit cu){
    //     String importStr = "";
    //     List<ImportDeclaration> imports = cu.getImports();
    //     if(imports.size()>0){
    //         for(ImportDeclaration imp : imports){
    //             importStr += imp.toString();
    //         }
    //     }
    //     if(implementationClassList.size()>0){
    //         for(String imp : implementationClassList){
    //             String impStr = "import java.util."+imp+";\n";
    //             if(!importStr.contains(impStr)){
    //                 importStr += impStr;
    //             }
    //         }
    //     }
    ...
    // public List<String> generateDec(String name,String type){

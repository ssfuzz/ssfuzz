...
public class GroupGenerator{
    ...
    // static final String[] groupTypeSet = {"Set","List","Map"};
    ...
    List<VariableComponent> generateGroup(String variableTypeStr,String variableName,String paramPattern){
        ...
        if(groupInfo.getImplementationClass().length()>0){
            // resultList.add(new VariableComponent(variableTypeStr,variableName,groupInfo.getValue(),"java.util."+groupInfo.getImplementationClass()));
